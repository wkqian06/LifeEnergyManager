...
[English guide](user-guide.en.md) · [返回 README](../README.md)
...
需要查看 Goal Drift Guard 和 Plan Modification 的实际判断、阻塞、确认和提交路由时，请参阅 [技术流程图](../REFERENCE.md#detailed-technical-workflow)。
...
需要安装与平台配置时，请阅读 [README](../README.md)；需要精确的 prompts、skills 和文件契约时，请阅读 [REFERENCE](../REFERENCE.md)。
