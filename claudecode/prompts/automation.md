...
- produce the three daily metrics (energy reserve, predicted next-day drive, actual drive) per the tracker Daily Scoring Model using the life-energy-drive-resistance skill: blind pass first, then read my self-scores and calibrate; actual drive is a single blind value,
