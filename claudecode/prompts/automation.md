...
- produce the three daily metrics (energy remaining, predicted next-day drive, actual start-of-day drive) per the tracker Daily Scoring Model using the life-energy-drive-resistance skill: blind pass first, then read my self-scores and calibrate; actual start-of-day drive is a single blind value,
