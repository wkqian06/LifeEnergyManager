...
- produce the three daily metrics (energy remaining, predicted next-day drive, actual drive) per the tracker Daily Scoring Model using $life-energy-drive-resistance: blind pass first, then read my self-scores and calibrate; actual drive is a single blind value,
